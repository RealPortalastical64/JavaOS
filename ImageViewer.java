...
public class ImageViewer
{
    ...
    public ImageViewer()
    {
        ...
        fileChooser.addChoosableFileFilter(new MyFileFilter(".jpg","JPG File (*.jpg)"));
        fileChooser.addChoosableFileFilter(new MyFileFilter(".jpeg","JPEG File (*.jpeg)"));
        fileChooser.addChoosableFileFilter(new MyFileFilter(".png","PNG File (*.png)"));
        fileChooser.addChoosableFileFilter(new MyFileFilter(".gif","GIF File (*.gif)"));
        makeFrame();
    }
    /**
     * Create an ImageViewer and display its GUI on screen.
    ...
    {
        frame = new JInternalFrame("Image Viewer",true,true,true,true);
     ...
     */
    private void makeMenuBar(JInternalFrame frame)
    {
        ...
        item = new JMenuItem("About Image Viewer...");
            item.addActionListener(new ActionListener() {
