...
import p1.Pile.PileType;

public class GUI extends JInternalFrame implements ActionListener, MouseListener,
										   MouseMotionListener {
		...
		public class JPanelWithBackground extends JPanel {
			  ...
			  public JPanelWithBackground(String fileName) throws IOException {
				URL urlToImage = this.getClass().getResource(fileName);
			  	backgroundImage = ImageIO.read(new FileInputStream(fileName));
			  }
